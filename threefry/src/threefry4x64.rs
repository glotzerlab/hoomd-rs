...
impl<const R: usize> BlockRngCore for ThreeFry4x64Core<R> {
    ...
    fn generate(&mut self, results: &mut Self::Results) {
        ...
        if R.is_multiple_of(4) {
            ...
            // self.counter[3] = self.counter[3].wrapping_add(self.seed[(s + 3) % 5] + s as u64);
            self.counter[0] = self.counter[0].wrapping_add(self.seed[s % 5]);
            self.counter[1] = self.counter[1].wrapping_add(self.seed[(s + 1) % 5] + s as u64);
        }
...
mod tests {
    ...
    const THREEFRY_ZEROS_R20_OUTPUT: [u64; 17] = [
        ...
        18_357_982_510_970_189_783,
        12_354_030_924_662_507_215,
        12_503_861_584_681_510_376,
        1_778_461_614_283_641_761,
        9_134_779_410_353_255_532,
        10_363_835_989_626_335_534,
        5_452_226_390_561_539_520,
        16_775_718_759_200_670_076,
    ];
    // #[test]
    // fn test_threefry4x64_r13_zeros() {
    //     let mut x = ThreeFry4x64Rng::<13>::seed_from_u64(0);
