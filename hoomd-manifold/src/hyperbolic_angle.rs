...
/// Combine roations and boosts in hyperbolic space.
///
/// "Hyperbolic rotations" describe elements of the group SO(N,1), which
/// preserve hyperboloids embedded in [`crate::Minkowski`]. Transformations include
...
impl Distribution<HyperbolicAngle> for StandardUniform {
    ...
    ///
    /// Every point on the hyperboloid can be generated by a boost in the
    /// x-direction followed by a rotation. The [Baker-Campbell-Hausdorff Lemma] (<https://en.wikipedia.org/wiki/Baker%E2%80%93Campbell%E2%80%93Hausdorff_formula>)
    ...
    /// ```
    /// To avoid clustering around the cusp of the hyperboloid, the random
