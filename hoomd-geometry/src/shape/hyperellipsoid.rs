...
///     axes: [1.0.try_into()?, 2.0.try_into()?],
/// };
...
///     axes: [2.0.try_into()?, 2.0.try_into()?, 2.0.try_into()?],
/// };
...
///     axes: [0.5.try_into()?, 3.0.try_into()?],
/// };
...
/// let v_ij = [
///     0.0,
///     long_ellipse.axes[1].get() + round_ellipse.axes[1].get() - 0.1,
/// ]
/// .into();
///
/// assert_eq!(
...
///     axes: [1.0.try_into()?, 2.0.try_into()?, 3.0.try_into()?],
/// });
