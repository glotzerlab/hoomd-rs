...
use hoomd_interaction::{
    DeltaEnergyInsert, DeltaEnergyOne, PairwiseCutoff, TotalEnergy, pairwise::Isotropic, univariate::{Expanded, OverlapPenalty}
};
    ...
    VecCell<SiteKey, D>: PointsNearBall<Cartesian<D>, SiteKey>,
{
    ...
    let overlap_penalty_hamiltonian = PairwiseCutoff(Isotropic {
