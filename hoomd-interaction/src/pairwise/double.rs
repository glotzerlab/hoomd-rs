...
///     PairwiseCutoff,
///     pairwise::{AngularMask, Anisotropic, HardSphere, angular_mask::Patch},
///     univariate::Boxcar,
/// };
///
...
/// # }
/// ```
impl<A, B, S> SitePairEnergy<S> for (A, B)
where
    A: SitePairEnergy<S>,
    B: SitePairEnergy<S>,
{
    ...
    fn site_pair_energy_initial(&self, site_properties_i: &S, site_properties_j: &S) -> f64 {
        let site_pair_energy_initial_a = self
            .0
        ...
        let site_pair_energy_initial_b = self
            .1
            .site_pair_energy_initial(site_properties_i, site_properties_j);
    ...
    B: MaximumInteractionRange,
{
    ...
    fn maximum_interaction_range(&self) -> f64 {
        self.0
            ...
            .max(self.1.maximum_interaction_range())
    }
}
