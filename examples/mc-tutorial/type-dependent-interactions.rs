...
use hoomd_interaction::{
    DeltaEnergyOne, MaximumInteractionRange, PairwiseCutoff, SitePairEnergy, pairwise::Isotropic, univariate::{
...
// struct Test(f64, f64, f64);
struct Test<A, B> where A: Default, B: Copy + Clone {
// struct Test<B> {
    a: A,
    b: B,
    c: PairwiseCutoff<Isotropic<LennardJones>>,
}

// impl<B, S, X, C> ::hoomd_interaction::TotalEnergy<Microstate<B, S, X, C>> for Test
// where
// PairwiseCutoff<Isotropic<LennardJones>> : TotalEnergy<Microstate<B, S, X, C>>
// {
//     fn total_energy(&self, microstate: &Microstate<B, S, X, C>) -> f64 {
//         let mut total = 0.0;
//         total = total
//             + hoomd_interaction::TotalEnergy::total_energy(&self.a, microstate);
//         if total == f64::INFINITY {
//             return total;
//         }
//         total = total
//             + hoomd_interaction::TotalEnergy::total_energy(&self.b, microstate);
//         if total == f64::INFINITY {
//             return total;
//         }
//         total
