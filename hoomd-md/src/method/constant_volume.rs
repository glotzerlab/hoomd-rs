...
// Put copy+paste of the following two impl blocks for the new custom newtypes

/// Rotational motion in 3-dimensional cartesian space for simple bodies.
...
/// Rotational motion in 2-dimensional cartesian space for simple bodies.
