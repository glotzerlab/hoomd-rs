...
pub trait CellIntegral: Sized + Send {
    ...
    fn collect(&mut self, v0: DVec3, v1: DVec3, v2: DVec3, gener: DVec3);
...
impl CellIntegral for VolumeCentroidIntegral {
    ...
    fn collect(&mut self, v0: DVec3, v1: DVec3, v2: DVec3, gener: DVec3) {
        let volume = signed_volume_tet(v0, v1, v2, gener);
        self.volume += volume;
        self.centroid += volume * (v0 + v1 + v2 + gener);
    }
...
impl CellIntegral for VolumeIntegral {
    ...
    fn collect(&mut self, v0: DVec3, v1: DVec3, v2: DVec3, gener: DVec3) {
        self.volume += signed_volume_tet(v0, v1, v2, gener);
    }
...
impl<D: Copy, I: FaceIntegralWithData<Data = D>> FaceIntegrator<I> {
    ...
    pub(crate) fn collect(&mut self, v0: DVec3, v1: DVec3, v2: DVec3, gener: DVec3) {
        self.integral.collect(v0, v1, v2, gener);
    }
...
impl FaceIntegral for AreaCentroidIntegral {
    ...
    fn collect(&mut self, v0: DVec3, v1: DVec3, v2: DVec3, gener: DVec3) {
        let area = signed_area_tri(v0, v1, v2, gener);
        self.area += area;
...
impl FaceIntegral for AreaIntegral {
    ...
    fn collect(&mut self, v0: DVec3, v1: DVec3, v2: DVec3, gener: DVec3) {
        self.area += signed_area_tri(v0, v1, v2, gener);
    }
